...
// isTreeEntry reports whether the given Git file mode represents a tree
// (directory) entry. In the Git object model, mode 0o40000 is the standard
// mode for tree objects.
